...
// import mobile from "../BACKEND.png";
// import "./courses.css";
...
//             {/* <br></br><br></br> */}
//             <span className="course-price">Course Price:<strong>#800,000</strong> </span>
//           </p>
//           <p>
...
//           {/* <br></br> */}
//           <p>
//             Training is delivered by learned and seasoned trainers. The methods
//             employed including Lectures, Demonstrations, Practical, Self
//             Practice and workshop using real life case studies. The training is
//             at least 90% practical.
//           </p>
        
//             <h4 className="course-outline">Course Outline For Beginner</h4>
//             <ul>
...
// <li>Project</li>
// <li>File System in Node, Writing a file and other IO Operations</li>
...
//         <section>
//         <div className="more"> <p>Check Out More Courses...</p></div>
//       <div  className="others">  
//         <a href=".mobile" className="courses-btn">
//             Mobile Development
//           </a>
//           <a href=".mobile" className="courses-btn">
//             Web Development
